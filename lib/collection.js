 ...
 * @api public
 */
SkinCollection.prototype.findOne = function (id, callback) {
    return this._operateById('findOne', id, arguments);
};
 ...
 * @api public
 */
SkinCollection.prototype.updateOne = function (id, doc, callback) {
    var oldCb = callback;
    var _this = this;
    if (callback) {
        callback = function(error, res) {
 ...
 * @api public
 */
SkinCollection.prototype.remove = function (id, callback) {
    var oldCb = callback;
    var _this = this;
    if (callback) {
        callback = function(error, res) {
